...
<body style="overflow:hidden;">
    ...
    <div id="parent" style="transform-style:preserve-3d;transform:rotateZ(0deg);left:50%;top:50%;margin-left:-400px;margin-top:-400px;width:800px;height:800px; background-size:100% 100%; position:relative; border:solid 10px #6cf; border-radius:400px;">
        ...
        <div class="s1" style="position:absolute; top:-100px;height:200px;width:200px;left:300px;background-size:100% 100%; background-image:url('http://riki-riki.stor.sinaapp.com/image/test/1.jpg');transform-style:preserve-3d;"></div>

        <div class="s2" style="position:absolute; left:-100px;height:200px;width:200px;top:300px;background-size:100% 100%; background-image:url('http://riki-riki.stor.sinaapp.com/image/test/2.jpg');transform-style:preserve-3d;"></div>

        <div class="s3" style="position:absolute; bottom:-100px;height:200px;width:200px;left:300px;background-size:100% 100%; background-image:url('http://riki-riki.stor.sinaapp.com/image/test/3.jpg');transform-style:preserve-3d;"></div>

        <div class="s4" style="position:absolute; right:-100px;height:200px;width:200px;top:300px; background-size:100% 100%; background-image:url('http://riki-riki.stor.sinaapp.com/image/test/4.jpg');transform-style:preserve-3d;"> </div>

        <div style="transform-style:preserve-3d;transform:rotateZ(45deg);-webkit-transform-style:preserve-3d;-webkit-transform:rotateZ(45deg);-moz-transform-style:preserve-3d;-moz-transform:rotateZ(45deg);left:0;top:0;width:800px;height:800px; background-size:100% 100%; position:absolute; border:solid 0px #000; border-radius:250px;">
    

        <div class="s1" style="position:absolute; top:-100px;height:200px;width:200px;left:300px;background-size:100% 100%; background-image:url('http://riki-riki.stor.sinaapp.com/image/test/5.jpg');transform-style:preserve-3d;"></div>

        <div class="s2" style="position:absolute; left:-100px;height:200px;width:200px;top:300px;background-size:100% 100%; background-image:url('http://riki-riki.stor.sinaapp.com/image/test/6.jpg');transform-style:preserve-3d;"></div>

        <div class="s3" style="position:absolute; bottom:-100px;height:200px;width:200px;left:300px;background-size:100% 100%; background-image:url('http://riki-riki.stor.sinaapp.com/image/test/7.png');transform-style:preserve-3d;"></div>

        <div class="s4" style="position:absolute; right:-100px;height:200px;width:200px;top:300px; background-size:100% 100%; background-image:url('http://riki-riki.stor.sinaapp.com/image/test/8.jpg');transform-style:preserve-3d;"> </div>
